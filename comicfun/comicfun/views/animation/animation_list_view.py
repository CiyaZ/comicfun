...
def animation_list_page(request):
    """分页显示动画列表"""
    ...
    artifact_list = content_tag.artifact_set.all().filter(content_type=3).order_by('-last_modified_time')
    ...
    return render(request, 'animation/animation_list.html', {
